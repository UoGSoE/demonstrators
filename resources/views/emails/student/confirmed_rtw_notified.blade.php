...
As described, you should complete and return the Extended Workforce details form to the H.R./Finance Office, R721, Rankine Building (re-attached from previous email).  You should also bring your Passport and, if applicable, your visa, in order to perform your Right to Work (RtW) check.  Your RtW check will be confirmed by email within three working days - if you do not receive this email by the fourth working day, please contact the H.R./Finance Office, R721, Rankine Building.
