...
Vue.component('demonstrator-request', __webpack_require__(43));
...
Vue.component('ldap-staff', __webpack_require__(62));
Vue.component('student-notes', __webpack_require__(65));
Vue.component('student-positions', __webpack_require__(68));
...
if(content.locals) module.exports = content.locals;
// add the styles to the DOM
var update = __webpack_require__(49)("38531d20", content, false);
// Hot Module Replacement
if(false) {
 // When the styles change, update the <style> tags
 if(!content.locals) {
